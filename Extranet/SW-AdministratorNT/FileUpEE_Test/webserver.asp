...
oFileUpEE.DebugLogFile = "C:\Inetpub\wwwroot\FileUpE\ws-debuglogfile.txt"

oFileUpEE.AuditLogDestination(saWebServer) = saLogFile
oFileUpEE.AuditLogFile(saWebServer) = "C:\Inetpub\wwwroot\FileUpE\auditlog_WebServer.txt"
	...
	oFileUpEE.TargetURL = "http:\\localhost\FileUpEE_Test\fileserver.asp"
	
	'--- Set the directory on the fileserver where you want to save the files
	oFileUpEE.DestinationDirectory = "C:\Inetpub\wwwroot\FileUpE\"
	...
	On Error Resume Next
		intSAResult = oFileUpEE.SendRequest(Response)
		If Err.Number <> 0 Then
