...
function Decode_Key(User_Site, User_Account, User_Asset, User_Key)
  ...
  Master_Key = ((2 * CInt(User_Site) + (CLng(CLng(User_Account)/2)) + (CLng(CLng(User_Asset)/3)))) + CLng(User_Asset)
...
function Encode_Key(User_Site, User_Account, User_Asset)
    ...
    Encode_Key = ((2 * CInt(User_Site) + (CLng(CLng(User_Account)/2)) + (CLng(CLng(User_Asset)/3)))) + CLng(User_Asset)
