...
' --------------------------------------------------------------------------------------  
  ...
  if IsNumeric(Account_ID) then  ' Account_ID came from the request object
      ...
      if not rs.EOF then
        FormName = "NTAccount"
      %>
        <FORM NAME="<%=FormName%>" ACTION="account_admin.asp" METHOD="<%=Post_Method%>" onsubmit="return(CheckRequiredFields(this.form));" onKeyUp="highlight(event)" onClick="highlight(event)" ID="Form1">
        <INPUT TYPE="Hidden" NAME="ID" VALUE="<%=Account_ID%>" ID="Hidden1">
        <INPUT TYPE="Hidden" NAME="Site_ID" VALUE="<%=Site_ID%>" ID="Hidden2">
        <INPUT TYPE="Hidden" NAME="Site_Code" VALUE="<%=Site_Code%>" ID="Hidden3">
        <INPUT TYPE="Hidden" NAME="BackURL" VALUE="<%=BackURL%>" ID="Hidden4">
        <INPUT TYPE="Hidden" NAME="HomeURL" VALUE="<%=HomeURL%>" ID="Hidden5">
        <INPUT TYPE="Hidden" NAME="ChangeID" VALUE="<%=Admin_ID%>" ID="Hidden6">
        <INPUT TYPE="Hidden" NAME="ChangeDate" Value="<%=Date%>" ID="Hidden7">
        <INPUT TYPE="Hidden" NAME="CM_ID" Value="<%=rs("CM_ID")%>" ID="Hidden8">        
        ...
        <TABLE WIDTH="100%" BORDER=0 BORDERCOLOR="GRAY" CELLPADDING=0 CELLSPACING=0 ALIGN=CENTER ID="Table1">
      	<TR>
...
<!--
      <TR>
              	 <TD BGCOLOR="#EEEEEE" VALIGN=MIDDLE CLASS=Medium>
                    <%=Translate("Grant Price List Access",Login_Language,conn)%>:
                 </TD>
              	 <TD BGCOLOR="#EEEEEE" ALIGN=CENTER CLASS=Medium>&nbsp;</TD>                                                
      	         <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium NOWRAP>
	<INPUT TYPE="Checkbox" NAME="CheckboxPriceList" CLASS=Medium ID="CheckboxPriceList" <%if rs("PriceListFlag") = True then response.write " CHECKED"%>>
...
-->
               ...
               <!-- Name -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium NOWRAP>
                  <INPUT TYPE="Text" NAME="FirstName" SIZE="10" MAXLENGTH="50" VALUE="<%=rs("FirstName")%>" CLASS=Medium ID="Text1">&nbsp;&nbsp;&nbsp;<INPUT TYPE="Text" NAME="MiddleName" SIZE="6" MAXLENGTH="50" VALUE="<%=rs("MiddleName")%>" CLASS=Medium ID="Text2">&nbsp;&nbsp;&nbsp;<IMG SRC="/images/required.gif" Border=0 WIDTH="10" HEIGHT="10" ALIGN=ABSMIDDLE><INPUT TYPE="Text" NAME="LastName" SIZE="11" MAXLENGTH="50" VALUE="<%=rs("LastName")%>" CLASS=Medium ID="Text3"> <B>,</B>&nbsp;&nbsp;&nbsp;<INPUT TYPE="Text" NAME="Suffix" SIZE="2" MAXLENGTH="50" VALUE="<%=rs("Suffix")%>" CLASS=Medium ID="Text4">
                </TD>
              </TR>
              ...
              <!-- Initials -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium NOWRAP>
                  <INPUT TYPE="Text" NAME="Initials" SIZE="10" MAXLENGTH="10" VALUE="<%=rs("Initials")%>" CLASS=Medium ID="Text5">
                </TD>
              </TR>
              ...
              <!-- Gender -->
                  ...
                  sValue = rs("Gender")
                  %>
                  <SELECT CLASS=Medium NAME="Gender" CLASS=Medium ID="Select1">
               ...
               <!-- Job Title -->
                  ...
                  <INPUT TYPE="Text" NAME="Job_Title" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Job_Title")%>" CLASS=Medium ID="Text6">
                </TD>
              </TR>
               ...
               <!-- Office Phone (Direct) -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_Phone" SIZE="28" MAXLENGTH="50" VALUE="<%=rs("Business_Phone")%>" CLASS=MEDIUM ID="Text7">&nbsp;&nbsp;<%=Translate("Extension",Login_Language,conn)%>: <INPUT TYPE="Text" NAME="Business_Phone_Extension" SIZE="10" MAXLENGTH="50" VALUE="<%=rs("Business_Phone_Extension")%>" CLASS=Medium ID="Text8">
                </TD>
              </TR>
               ...
               <!-- Mobile Phone -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Mobile_Phone" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Mobile_Phone")%>" CLASS=Medium ID="Text9">
                </TD>
              </TR>
               ...
               <!-- Pager -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Pager" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Pager")%>" CLASS=Medium ID="Text10">
                </TD>
              </TR>
               ...
               <!-- Email -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Email" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Email")%>" CLASS=Medium ID="Text11">
                </TD>
              </TR>
              ...
              <!-- EMail Method -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <SELECT Name="EMail_Method" CLASS=Medium ID="Select2">
             ...
             <!-- Connection Speed -->
              ...
              <!-- Subscription Service -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>                  
                  <INPUT TYPE="Checkbox" NAME="Subscription" <%if rs("Subscription") = True then response.write " CHECKED"%> CLASS=Medium ID="Checkbox1">
                </TD>
              </TR>
              ...
              <!-- Preferred Language -->
                  ...
                  <SELECT Name="Account_Language" CLASS=Medium ID="Select3">    
                  <%
              ...
              <% if rs("Password") <> "(hidden)" and not isblank("Password") and CInt(rs("NewFlag")) = CInt(False) then %>
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                    <INPUT TYPE="Text" NAME="Password_Change" SIZE="50" MAXLENGTH="14" VALUE="" CLASS=Medium ID="Text12">
                </TD>
              </TR>
              <% else %>
                <INPUT TYPE="HIDDEN" NAME="Password_Change" Value="" ID="Hidden9">
              <% end if %>
               ...
               <!-- Company -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Company" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Company")%>" CLASS=Medium ID="Text13">
                </TD>
              </TR>
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Company_Website" SIZE="50" MAXLENGTH="255" VALUE="<%=rs("Company_Website")%>" CLASS=Medium ID="Text14">
                </TD>
              </TR>
              ...
              <!-- Business Address -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_Address" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Business_Address")%>" CLASS=Medium ID="Text15"><BR>
                  <INPUT TYPE="Text" NAME="Business_Address_2" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Business_Address_2")%>" CLASS=Medium ID="Text16">                
                </TD>
              </TR>
               ...
               <!-- Mail Stop -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_MailStop" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Business_MailStop")%>" CLASS=Medium ID="Text17">
                </TD>
              </TR>
              ...
              <!-- Business City -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_City" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Business_City")%>" CLASS=Medium ID="Text18">
                </TD>
              </TR>
              ...
              <!-- Business State -->
                  ...
                  <SELECT NAME="Business_State" CLASS=Medium ID="Select4">  
                   <%
              ...
              <!-- Business State Other-->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_State_Other" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Business_State_Other")%>" CLASS=Medium ID="Text19">
                </TD>
              </TR>
              ...
              <!-- Business Postal Code -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_Postal_Code" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Business_Postal_Code")%>" CLASS=Medium ID="Text20">
                </TD>
              </TR>
              ...
              <!-- Email 2 -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Email_2" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Email_2")%>" CLASS=Medium ID="Text21">
                </TD>
              </TR>              
              ...
              <!-- Business Phone 2 -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_Phone_2" SIZE="28" MAXLENGTH="50" VALUE="<%=rs("Business_Phone_2")%>" ID="Text22">&nbsp;&nbsp;<%=Translate("Extension",Login_Language,conn)%>: <INPUT TYPE="Text" NAME="Business_Phone_2_Extension" SIZE="10" MAXLENGTH="50" VALUE="<%=rs("Business_Phone_2_Extension")%>" CLASS=Medium ID="Text23">
                </TD>
              </TR>
              ...
              <!-- Business Fax -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Business_Fax" SIZE="28" MAXLENGTH="50" VALUE="<%=rs("Business_Fax")%>" ID="Text24">
                </TD>
              </TR>
              ...
              <!-- Postal Address -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Postal_Address" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Postal_Address")%>" CLASS=Medium ID="Text25"><BR>
                </TD>
              </TR>
              ...
              <!-- Postal Same -->
                  ...
                  <INPUT TYPE="Checkbox" NAME="PostalSame" CLASS=Medium ID="Checkbox2">&nbsp;&nbsp;<%=Translate("click checkbox",Login_Language,conn)%>
                </TD>
              </TR>
               ...
               <!-- Postal City -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Postal_City" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Postal_City")%>" CLASS=Medium ID="Text26">
                </TD>
              </TR>
               ...
               <!-- Postal State -->
                  ...
                  <SELECT NAME="Postal_State" CLASS=Medium ID="Select5">
              ...
              <!-- Postal State Other-->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Postal_State_Other" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Postal_State_Other")%>" CLASS=Medium ID="Text27">
                </TD>
              </TR>
              ...
              <!-- Postal Postal Code -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Postal_Postal_Code" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Postal_Postal_Code")%>" CLASS=Medium ID="Text28">
                </TD>
              </TR>
              ...
              <!-- Ship Same -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=SmallRed>
                  <INPUT TYPE="Checkbox" NAME="ShippingSame" CLASS=Medium ID="Checkbox3">&nbsp;&nbsp;<%=Translate("click checkbox",Login_Language,conn)%>
                </TD>
              </TR>
              ...
              <!-- Shipping Address -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Shipping_Address" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Shipping_Address")%>" CLASS=Medium ID="Text29"><BR>
                  <INPUT TYPE="Text" NAME="Shipping_Address_2" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Shipping_Address_2")%>" CLASS=Medium ID="Text30">                
                </TD>
              </TR>
              ...
              <!-- Shipping Mail Stop -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Shipping_MailStop" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Shipping_MailStop")%>" CLASS=Medium ID="Text31">
                </TD>
              </TR>
               ...
               <!-- Shipping City -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Shipping_City" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Shipping_City")%>" CLASS=Medium ID="Text32">
                </TD>
              </TR>
               ...
               <!-- Shipping State -->
                  ...
                  <SELECT NAME="Shipping_State" CLASS=Medium ID="Select6">
              ...
              <!-- Shipping State Other-->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Shipping_State_Other" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Shipping_State_Other")%>" CLASS=Medium ID="Text33">
                </TD>
              </TR>
              ...
              <!-- Shipping Postal Code -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
                  <INPUT TYPE="Text" NAME="Shipping_Postal_Code" SIZE="50" MAXLENGTH="50" VALUE="<%=rs("Shipping_Postal_Code")%>" CLASS=Medium ID="Text34">
                </TD>
              </TR>
...
'                     if instr(1,lcase(rs("SubGroups")), "account") > 0 then                      
                    ...
                    if Admin_Access >= 6 then
                    	...
                    	'Modified by zensar 
																						'<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
																						if site_id =3 then
																												if IsNumeric(Account_ID) then
																																set cmd = Server.CreateObject("ADODB.Command")
																																cmd.ActiveConnection = conn
																																cmd.CommandType = adCmdStoredProc
																																cmd.CommandText = "FMGetUser"
																																cmd.Parameters.Append cmd.CreateParameter("@UserName",adVarChar,adParamInput,100,"")
																																cmd.Parameters.Append cmd.CreateParameter("@Password",adVarChar,adParamInput,100,"")
																																cmd.Parameters.Append cmd.CreateParameter("@AccountId",adInteger,adParamInput,Account_ID)
																																cmd.Parameters.Append cmd.CreateParameter("@UpdateLoginDate",adBoolean,adParamInput,0)
																																cmd.Parameters(0).value=""
																																cmd.Parameters(1).value=""
																																cmd.Parameters(2).value=Account_ID
																																cmd.Parameters(3).value=0
																																set rsFM = cmd.execute
																																if rsFM.EOF then
																																				if Admin_Access >= 6 then
																																								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT ENABLED TYPE=""Checkbox"" NAME=""CFMEnabled"" VALUE=""1"" CLASS=Medium></TD><TD CLASS=MediumRed>" & Translate(Trim("Field Marketing Enabled"),Login_Language,conn) & "</TD></TR>" & vbCrLf
																																				else
																																								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT TYPE=""HIDDEN"" NAME=""CFMEnabled"" VALUE=""1"" CLASS=Medium></TD><TD CLASS=MediumRed>" & "" & "</TD></TR>" & vbCrLf
																																				end if
																																else
																																				if Admin_Access >= 6 then
																																								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT ENABLED TYPE=""Checkbox"" CHECKED NAME=""CFMEnabled"" VALUE=""1"" CLASS=Medium></TD><TD CLASS=MediumRed>" & Translate(Trim("Field Marketing enabled"),Login_Language,conn) & "</TD></TR>" & vbCrLf
																																				else
																																								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT TYPE=""HIDDEN""  NAME=""CFMEnabled"" VALUE=""1"" CLASS=Medium></TD><TD CLASS=MediumRed>" & "" & "</TD></TR>" & vbCrLf
																																				end if
																																end if
																																...
																																if Admin_Access >= 6 then
																																			response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT ENABLED TYPE=""Checkbox"" CHECKED NAME=""CFMEnabled"" VALUE=""0"" CLASS=Medium></TD><TD CLASS=MediumRed>" & Translate(Trim("Field Marketing enabled"),Login_Language,conn) & "</TD></TR>" & vbCrLf
																																else
																																			response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT TYPE=""HIDDEN"" NAME=""CFMEnabled"" VALUE=""0"" CLASS=Medium></TD><TD CLASS=MediumRed>" & "" & "</TD></TR>" & vbCrLf
																																end if
																												end if
																						end if
																						'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
'                    end if
              ...
              <% if Admin_Access >=8 then %>      
				...
				''' Updated by Zensar to Display Site Description as per Task#546 ''''''''

                        ''response.write "<FONT COLOR=""Red"">" & rs("Groups") & ",</FONT> "

		  		Dim strSQLGetDescr, rsGetSiteDescr

				strSQLGetDescr = "SELECT Site_Short_Descr from Site where Site_Code='" & rs("Groups") & "'"
				
				set rsGetSiteDescr=Server.CreateObject("Adodb.Recordset")
				rsGetSiteDescr.Open strSQLGetDescr, conn, 3, 3
				if not rsGetSiteDescr.eof then
					response.write "<FONT COLOR=""Red"">" & rsGetSiteDescr("Site_Short_Descr") & ",</FONT> "
				end if
				rsGetSiteDescr.Close
              ...
              %>             
               ...
               <!-- EMail Update -->
      	        ...
      	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>                  
                   <INPUT TYPE="Checkbox" NAME="send_email_user"<%if CInt(rs("NewFlag")) = CInt(True) or CInt(rs("NewFlag")) = -2 then response.write " CHECKED"%> CLASS=Medium ID="Checkbox4"><%=Translate("User",Login_Language,conn)%><BR>
                   <INPUT TYPE="Checkbox" NAME="send_email_fcm" CLASS=Medium ID="Checkbox5"><%=Translate("Account Manager",Login_Language,conn)%><BR>
                   <INPUT TYPE="Checkbox" NAME="send_email_admin" Class CLASS=Medium ID="Checkbox6"><%=Translate("Site Administrator",Login_Language,conn)%>
                </TD>
              </TR>
              ...
              <TD COLSPAN=3 CLASS=Medium>
                <TABLE WIDTH=100% CELLPADDING=2 BGCOLOR="#666666" ID="Table4">
                  <TR>
                    ...
                    <TD ALIGN=LEFT WIDTH="30%" CLASS=Medium>&nbsp;
                      <INPUT TYPE="Submit" NAME="Update" VALUE=" <%=Translate("Update",Login_Language,conn)%> " CLASS=NavLeftHighlight1 onmouseover="this.className='NavLeftButtonHover'" onmouseout="this.className='Navlefthighlight1'" ID="Submit1">
                    </TD>
                    <TD ALIGN=CENTER WIDTH="30%" CLASS=Medium>
                      <INPUT TYPE="Submit" NAME="Delete" VALUE=" <%=Translate("Delete",Login_Language,conn)%> " CLASS=NavLeftHighlight1 onmouseover="this.className='NavLeftButtonHover'" onmouseout="this.className='Navlefthighlight1'" ID="Submit2">
                    </TD>
                  </TR>        
                </TABLE>
              </TD>
...
' --------------------------------------------------------------------------------------
  ...
  if lcase(Account_ID) = "add" then
   ...
   if isblank(request("Core_EMail")) then %>
    ...
    <FORM NAME="Check_Email" ACTION="account_edit.asp" METHOD="<%=Post_Method%>" onKeyUp="highlight(event)" onClick="highlight(event)" ID="Form2">
    <INPUT TYPE="Hidden" NAME="ID" VALUE="edit_account" ID="Hidden10">
    <INPUT TYPE="Hidden" NAME="Site_ID" VALUE="<%=Site_ID%>" ID="Hidden11">
    <INPUT TYPE="Hidden" NAME="Account_ID" VALUE="add" ID="Hidden12">
    <INPUT TYPE="Hidden" NAME="BackURL" VALUE="<%=BackURL%>" ID="Hidden13">
    <INPUT TYPE="Hidden" NAME="HomeURL" VALUE="<%=HomeURL%>" ID="Hidden14">
    <INPUT TYPE="Hidden" NAME="Reg_Request_Date" VALUE="<%=Now%>" ID="Hidden15">

    <%Call Table_Begin%>                  
    <TABLE WIDTH="100%" BORDER=0 BORDERCOLOR="GRAY" CELLPADDING=0 CELLSPACING=0 ALIGN=CENTER ID="Table5">
    	<TR>
     		<TD WIDTH="100%" BGCOLOR="#EEEEEE">
   	  		<TABLE WIDTH="100%" CELLPADDING=4 BORDER=0 ID="Table6">                   
   		 	  	<TR>
                ...
                <INPUT TYPE="Text" NAME="Core_Email" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text35">&nbsp;&nbsp;<INPUT TYPE="Submit" VALUE=" Search " CLASS=NavLeftHighlight1 ID="Submit3" NAME="Submit3">
              </TD>
            </TR>
          </TABLE>
        </TD>
    ...
    <FORM NAME="<%=FormName%>" ACTION="account_admin.asp" METHOD="<%=Post_Method%>" onsubmit="return CheckRequiredFields(this.form);" onKeyUp="highlight(event)"  Language="JavaScript" onClick="highlight(event)" ID="Form3">
    <INPUT TYPE="Hidden" NAME="ID" VALUE="add" ID="Hidden16">
    <INPUT TYPE="Hidden" NAME="Site_ID" VALUE="<%=Site_ID%>" ID="Hidden17">
    <INPUT TYPE="Hidden" NAME="Site_Code" VALUE="<%=Site_Code%>" ID="Hidden18">
    <INPUT TYPE="Hidden" NAME="BackURL" VALUE="<%=BackURL%>" ID="Hidden19">
    <INPUT TYPE="Hidden" NAME="HomeURL" VALUE="<%=HomeURL%>" ID="Hidden20">
    <INPUT Type="Hidden" NAME="NewFlag" Value="on" ID="Hidden21">
    <INPUT TYPE="Hidden" NAME="ChangeID" VALUE="<%=Admin_ID%>" ID="Hidden22">                                  
    <INPUT TYPE="Hidden" NAME="ChangeDate" Value="<%=Date%>" ID="Hidden23">
	  <INPUT TYPE="Hidden" NAME="SubGroups" ID="Hidden24">

    <TABLE WIDTH="100%" BORDER=1 BORDERCOLOR="GRAY" CELLPADDING=0 CELLSPACING=0 ALIGN=CENTER ID="Table7">
  	<TR>
  		<TD WIDTH="100%" BGCOLOR="#EEEEEE" CLASS=Medium>
  			<TABLE WIDTH="100%" CELLPADDING=4 BORDER=0 ID="Table8">
...
<!--
      <TR>
              	 ...
              	 <TD BGCOLOR="#EEEEEE" ALIGN=CENTER CLASS=Medium>&nbsp;</TD>                                                
      	         <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium NOWRAP>
	<INPUT TYPE="Checkbox" NAME="CheckboxPriceList" CLASS=Medium ID="CheckboxPriceList">
...
-->
           ...
           <!-- Name -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium NOWRAP>
              <INPUT TYPE="Text" NAME="FirstName" SIZE="10" MAXLENGTH="50" VALUE="<%=Core(2)%>" CLASS=Medium ID="Text36">&nbsp;&nbsp;&nbsp;<INPUT TYPE="Text" NAME="MiddleName" SIZE="6" MAXLENGTH="50" VALUE="<%=Core(3)%>" CLASS=Medium ID="Text37">&nbsp;&nbsp;&nbsp;<IMG SRC="/images/required.gif" Border=0 WIDTH="10" HEIGHT="10" ALIGN=ABSMIDDLE><INPUT TYPE="Text" NAME="LastName" SIZE="11" MAXLENGTH="50" VALUE="<%=Core(4)%>" CLASS=Medium ID="Text38"> <B>,</B>&nbsp;&nbsp;&nbsp;<INPUT TYPE="Text" NAME="Suffix" SIZE="2" MAXLENGTH="50" VALUE="<%=Core(5)%>" CLASS=Medium ID="Text39">
            </TD>
      </TR>
          ...
          <!-- Initials -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium NOWRAP>
              <INPUT TYPE="Text" NAME="Initials" SIZE="10" MAXLENGTH="10" VALUE="" CLASS=Medium ID="Text40">
            </TD>
          </TR>
          ...
          <!-- Gender -->
              ...
              sValue = Core(1)
              %>
              <SELECT CLASS=Medium NAME="Gender" CLASS=Medium ID="Select7">
                <OPTION CLASS=Medium VALUE=""><%=Translate("Select",Login_Language,conn)%></OPTION>
           ...
           <!-- Job Title -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Job_Title" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(20)%>" CLASS=Medium ID="Text41">
            </TD>
          </TR>
           ...
           <!-- Business Phone -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_Phone" SIZE="28" MAXLENGTH="50" VALUE="<%=Core(17)%>" ID="Text42">&nbsp;&nbsp;<%=Translate("Extension",Login_Language,conn)%>: <INPUT TYPE="Text" NAME="Business_Phone_Extension" SIZE="10" MAXLENGTH="50" VALUE="<%=Core(18)%>" CLASS=Medium ID="Text43">
            </TD>
          </TR>
           ...
           <!-- Mobile Phone -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Mobile_Phone" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text44">
            </TD>
          </TR>
           ...
           <!-- Pager -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Pager" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text45">
            </TD>
          </TR>
           ...
           <!-- Email -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Email" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(16)%>" CLASS=Medium ID="Text46">
            </TD>
          </TR>
          ...
          <!-- EMail Method -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <SELECT Name="EMail_Method" CLASS=Medium ID="Select8">
                <OPTION CLASS=Medium VALUE=""><%=Translate("Select from List",Login_Language,conn)%></OPTION>
                <OPTION CLASS=Medium Value=""></OPTION>
           ...
           <!-- Subscription Service -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Checkbox" NAME="Subscription" CHECKED CLASS=Medium ID="Checkbox7">
            </TD>
          </TR>
          ...
          <!-- Preferred Language -->
              ...
              <SELECT Name="Account_Language" CLASS=Medium ID="Select9">    
              <%
              SQL = "SELECT * FROM Language WHERE Language.Enable=" & CInt(True) & " ORDER BY Language.Sort"
              Set rsLanguage = Server.CreateObject("ADODB.Recordset")
              rsLanguage.Open SQL, conn, 3, 3
          ...
          <!-- Expiration Date -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="ExpirationDate" SIZE="10" MAXLENGTH="50" VALUE="12/31/<%=DatePart("yyyy",Date)%>" CLASS=Medium ID="Text47">&nbsp;&nbsp;
              <A HREF="javascript:void()" LANGUAGE="JavaScript" onClick="window.dateField = document.<%=FormName%>.ExpirationDate;calendar = window.open('/sw-common/sw-calendar_picker.asp','cal','WIDTH=200,HEIGHT=250');return false"><IMG SRC="/images/calendar/calendar_icon.gif" BORDER=0 HEIGHT="21"ALIGN=TOP></A>
            </TD>
          </TR>
           <!-- NT Login -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>              
              <INPUT TYPE="Text" NAME="NTLogin" SIZE="50" MAXLENGTH="30" VALUE="" CLASS=Medium ID="Text48">
            </TD>
          </TR>
           ...
           <!-- NT Password -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Password" SIZE="50" MAXLENGTH="30" VALUE="" CLASS=Medium ID="Text49">
              <INPUT TYPE="HIDDEN" NAME="Password_Change" Value="" ID="Hidden25">              
            </TD>
          </TR>
           ...
           <!-- Company -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Company" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(8)%>" CLASS=Medium ID="Text50">
            </TD>
          </TR>
           ...
           <!-- Company Website -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Company_Website" SIZE="50" MAXLENGTH="255" VALUE="" CLASS=Medium ID="Text51">
            </TD>
          </TR>
          ...
          <!-- Business Address -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_Address" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(9)%>" CLASS=Medium ID="Text52"><BR>
              <INPUT TYPE="Text" NAME="Business_Address_2" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(10)%>" CLASS=Medium ID="Text53">                
            </TD>
          </TR>
          ...
          <!-- Business Mail Stop -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_MailStop" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(7)%>" CLASS=Medium ID="Text54">
            </TD>
          </TR>
          ...
          <!-- Business City -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_City" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(11)%>" CLASS=Medium ID="Text55">
            </TD>
          </TR>
          ...
          <!-- Business State -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <% SValue = Core(12)%>
              <SELECT NAME="Business_State" CLASS=Medium ID="Select10">
           ...
           <!-- Business State Other-->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_State_Other" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(13)%>" CLASS=Medium ID="Text56">
            </TD>
          </TR>
           ...
           <!-- Business Postal Code -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_Postal_Code" SIZE="50" MAXLENGTH="50" VALUE="<%=Core(14)%>" CLASS=Medium ID="Text57">
            </TD>
          </TR>
          ...
          <!-- Business Phone 2-->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_Phone_2" SIZE="28" MAXLENGTH="50" VALUE="" ID="Text58">&nbsp;&nbsp;<%=Translate("Extension",Login_Language,conn)%>: <INPUT TYPE="Text" NAME="Business_Phone_2_Extension" SIZE="10" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text59">
            </TD>
          </TR>
           ...
           <!-- Email 2 -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Email_2" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text60">
            </TD>
          </TR>
          ...
          <!-- Business Fax -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Business_Fax" SIZE="28" MAXLENGTH="50" VALUE="" ID="Text61">
            </TD>
          </TR>
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Postal_Address" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text62"><BR>
            </TD>
          </TR>
          ...
          <!-- Postal Same -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=SmallRed>
              <INPUT TYPE="Checkbox" NAME="PostalSame" CLASS=Medium ID="Checkbox8">&nbsp;&nbsp;<%=Translate("click checkbox",Login_Language,conn)%>
            </TD>
          </TR>
           ...
           <!-- Postal City -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Postal_City" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text63">
            </TD>
          </TR>
           ...
           <!-- Postal State -->
              ...
              <% SValue = "" %>              
              <SELECT NAME="Postal_State" CLASS=Medium ID="Select11">
           ...
           <!-- Postal State Other-->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Postal_State_Other" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text64">
            </TD>
          </TR>
           ...
           <!-- Postal Postal Code -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Postal_Postal_Code" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text65">
            </TD>
          </TR>
          ...
          <!-- Shipping Same -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=SmallRed>
              <INPUT TYPE="Checkbox" NAME="ShippingSame" CLASS=Medium ID="Checkbox9">&nbsp;&nbsp;<%=Translate("click checkbox",Login_Language,conn)%>
            </TD>
          </TR>
          ...
          <!-- Shipping Address -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Shipping_Address" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text66"><BR>
              <INPUT TYPE="Text" NAME="Shipping_Address_2" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text67">                
            </TD>
          </TR>
           ...
           <!-- Shipping Mail Stop -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Shipping_MailStop" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text68">
            </TD>
          </TR>              
          ...
          <!-- Shipping City -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Shipping_City" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text69">
            </TD>
          </TR>
          ...
          <!-- Shipping State -->
              ...
              <% SValue = "" %>              
              <SELECT NAME="Shipping_State" CLASS=Medium ID="Select12">
          ...
          <!-- Shipping State Other-->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Shipping_State_Other" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text70">
            </TD>
          </TR>
          ...
          <!-- Shipping Postal Code -->
  	        ...
  	        <TD BGCOLOR="White" ALIGN=LEFT CLASS=Medium>
              <INPUT TYPE="Text" NAME="Shipping_Postal_Code" SIZE="50" MAXLENGTH="50" VALUE="" CLASS=Medium ID="Text71">
            </TD>
          </TR>
          ...
          <!-- EMail Update -->
              ...
              <% if Account_ID <> false then %>                    
                <INPUT TYPE="Checkbox" NAME="send_email_user" CHECKED CLASS=Medium ID="Checkbox10"><%=Translate("User",Login_Language,conn)%><BR>
                <INPUT TYPE="Checkbox" NAME="send_email_fcm" CLASS=Medium ID="Checkbox11"><%=Translate("Account Manager",Login_Language,conn)%><BR>
                <INPUT TYPE="Checkbox" NAME="send_email_admin" CLASS=Medium ID="Checkbox12"><%=Translate("Site Administrator",Login_Language,conn)%>
              <% else %>
                 &nbsp;  
              <% end if %>
            </TD>
          ...
          <TR>
          <TD COLSPAN=3 CLASS=Medium>
            <TABLE WIDTH=100% CELLPADDING=2 BGCOLOR="#666666" ID="Table9">
              <TR>
...
<%
  ...
  <INPUT TYPE="BUTTON" Value=" <%=Translate("Main Menu",Login_Language,conn)%> " Language="JavaScript" onclick="location.href='default.asp?Site_ID=<%=Site_ID%>'" CLASS=NavLeftHighlight1 ID="Button1" NAME="Button1">
  <%Call Nav_Border_End%>
  <%
