...
'-----------------------------------------------------------------------
	...
	'dim r
'r= server.MapPath(request.ServerVariables())
  '--- Debug logging 
'oFileUpEE.DebugLevel = 1
'oFileUpEE.DebugLogFile = "D:\Extranet\SW-Administrator\FileUpE\ws-debuglogfile.txt"

oFileUpEE.AuditLogDestination(saWebServer) = saLogFile
oFileUpEE.AuditLogFile(saWebServer) = "D:\Extranet\SW-Administrator\FileUpE\auditlog_WebServer.txt"
	...
	oFileUpEE.TargetURL ="http://dtmevtvsdv15/sw-administrator/FileUpEE_Test/fileserver.asp"
	
	'--- Set the directory on the fileserver where you want to save the files
	oFileUpEE.DestinationDirectory = "D:\Extranet\SW-Administrator\FileUpEE_Test\"
