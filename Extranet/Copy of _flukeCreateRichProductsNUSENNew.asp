...
sqlinsert=""
	sqlinsert= "insert into ProductContent values(" & rspRODUCTS.fields("IG_PID").value & ",'" & m_lang & "','" & replace(RenderHTML(1),"'","''") & "')"
...
sqlinsert=""
	sqlinsert= "insert into ProductContent values(" & rspRODUCTS.fields("IG_PID").value & ",'" & m_lang & "','" & replace(RenderHTML(2),"'","''") & "')"
	oConn.execute sqlinsert
if err.number <> 0 then
oconn.close
oconn.open
...
err.clear
	...
	'response.write sqlinsert
sqlinsert=""	
	sqlinsert= "insert into ProductContent values(" & rspRODUCTS.fields("IG_PID").value & ",'" & m_lang & "','" & replace(RenderHTML(4),"'","''") & "')"
	oConn.execute sqlinsert
if err.number <> 0 then
oconn.close
oconn.open
