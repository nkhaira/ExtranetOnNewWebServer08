...
<%
  ...
  response.write "&nbsp;&nbsp;&nbsp;&nbsp;"
  response.write "            <INPUT TYPE=""Submit"" ID=""SubmitLogin"" NAME=""SubmitLogin"" onclick=""CheckMetSupportSelection();"" VALUE="" " & Translate("Logon",Login_Language,conn) & " "" CLASS=NavLeftHighlight1>"
  
  if Reg_Freeze = False then
    response.write "&nbsp;&nbsp;&nbsp;&nbsp;<SPAN CLASS=SmallBoldWhite>" & Translate("or",Login_language,conn) & "</SPAN>&nbsp;&nbsp;&nbsp;"
    response.write "            <INPUT TYPE=""Submit"" ID=""SubmitRegister"" onclick=""CheckMetSupportSelection();"" NAME=""SubmitRegister"" VALUE="" " & Translate("Register",Login_Language,conn) & " "" CLASS=NavLeftHighlight1>" & vbCrLf
  end if
...
<script language="JavaScript">
  ...
  function CheckMetSupportSelection()
  {
    if(document.WhereToGo.Site_Select.value.toLowerCase() == "met-support"){	        
            document.getElementById('SubmitLogin').setAttribute('disabled', 'disabled');
            document.getElementById('SubmitLogin').style.backgroundColor ='#dddddd';
            document.getElementById('SubmitRegister').setAttribute('disabled', 'disabled');
            document.getElementById('SubmitRegister').style.backgroundColor ='#dddddd';
