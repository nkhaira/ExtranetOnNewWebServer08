...
'                    end if
                    ...
                    if site_id =3 then
						...
						cmd.Parameters.Append cmd.CreateParameter("@UserName",adVarChar,adParamInput,100,trim(Session("LOGON_USER")))
						cmd.Parameters.Append cmd.CreateParameter("@Password",adVarChar,adParamInput,100,trim(Session("Password")))
						cmd.Parameters.Append cmd.CreateParameter("@AccountId",adInteger,adParamInput,0)
						cmd.Parameters.Append cmd.CreateParameter("@UpdateLoginDate",adBit,adParamInput,0)
						...
						if rs.EOF then
							if Admin_Access = 9 then
								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT ENABLED TYPE=""Checkbox"" NAME=""CFMEnabled"" VALUE="1" CLASS=Medium></TD><TD CLASS=MediumRed>" & Translate(Trim(rsGateway("Field Marketing enabled")),Login_Language,conn) & "</TD></TR>" & vbCrLf
							else
								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT ENABLED=""FALSE"" TYPE=""Checkbox"" NAME=""CFMEnabled"" VALUE="1" CLASS=Medium></TD><TD CLASS=MediumRed>" & Translate(Trim(rsGateway("Field Marketing enabled")),Login_Language,conn) & "</TD></TR>" & vbCrLf
							end if
						else
							if Admin_Access = 9 then
								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT ENABLED TYPE=""Checkbox"" CHECKED NAME=""CFMEnabled"" VALUE="1" CLASS=Medium></TD><TD CLASS=MediumRed>" & Translate(Trim(rsGateway("Field Marketing enabled")),Login_Language,conn) & "</TD></TR>" & vbCrLf
							else
								response.write "<TR><TD WIDTH=20 CLASS=Medium><INPUT ENABLED=""FALSE"" CHECKED TYPE=""Checkbox"" NAME=""CFMEnabled"" VALUE="1" CLASS=Medium></TD><TD CLASS=MediumRed>" & Translate(Trim(rsGateway("Field Marketing enabled")),Login_Language,conn) & "</TD></TR>" & vbCrLf
							end if
						end if
						rs.close
						set rs=nothing
