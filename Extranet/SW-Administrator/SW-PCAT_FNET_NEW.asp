...
'.write "	<div style='font-size: 1px'>&nbsp</div>" & vbCrLf
'.write "<script type='text/javascript'>" & vbCrLf
'.write "   var divid = 'teste'; " & vbCrLf
'.write "   document.getElementById(divid).getElementsByTagName('div')[0].style.width = document.getElementById(divid).getElementsByTagName('select')[0].offsetWidth+'px'; " & vbCrLf
'.write "  document.getElementById(divid).getElementsByTagName('select')[0].style.width = document.getElementById(divid).offsetWidth+'px'; " & vbCrLf
'.write "   document.getElementById(divid).onscroll = function scrollEvent() { this.getElementsByTagName('select')[0].style.width = parseInt(this.offsetWidth+this.scrollLeft)+'px'; } "& vbCrLf
'.write "</script> "& vbCrLf
'.write "</div> "& vbCrLf
...
'.write "</div> "& vbCrLf
    ...
    .write "    </TD>" & vbCrLf
    .write "	</TR>" & vbCrLf
	.write "<DIV overflow: scroll>" & vbCRLf
    .write "	<TR>" & vbCrLf
    .write "    <TD CLASS=Medium>" & vbCrLf
