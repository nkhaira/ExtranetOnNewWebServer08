...
if Admin_Access = 1 or Admin_Access = 2 or Admin_Access >= 3 then
  ...
  if Utility_ID = 0 and Admin_Access >= 4 then
    ...
    if rsUser.EOF and rsUser.BOF then
      ...
      <DIV ID="ContentTableStart" STYLE="position: absolute;">
    	...
    	<TABLE WIDTH="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 BORDERCOLOR="#666666" BGCOLOR="#666666" ID="Table1">
        <TR>
          <TD>
            <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0  WIDTH="100%" ID="Table2">
              <TR ID="ContentHeader1">
                ...
                <TD BGCOLOR="#666666" ALIGN="CENTER" class="SmallBoldWhite">ID</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   class="SmallBoldWhite">Users Name</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   class="SmallBoldWhite">Company</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   class="SmallBoldWhite">City</TD>              
                <TD BGCOLOR="#666666" ALIGN="LEFT"   class="SmallBoldWhite">State</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   class="SmallBoldWhite">Country</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   class="SmallBoldWhite">Phone Number</TD>            
                <TD BGCOLOR="#666666" ALIGN="LEFT"   class="SmallBoldWhite">Groups</TD>            
                <TD BGCOLOR="#666666" ALIGN="CENTER" class="SmallBoldWhite">Account Status</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" class="SmallBoldWhite">Last Logon</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" class="SmallBoldWhite">Account Expiration</TD>                                          
          	 </TR>
     <%
     end if
  ...
  elseif (Utility_ID = 1  or Utility_ID = 2) and Admin_Access >= 4 then
    ...
    if rsUser.EOF and rsUser.BOF then
      ...
      response.write "<BR>"
    %>
    	<TABLE WIDTH="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 BORDERCOLOR="#666666" BGCOLOR="#666666" ID="Table3">
        <TR>
          <TD>
            <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0  WIDTH="100%" ID="Table4">
              <TR>
                ...
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite>Phone Number</TD>            
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite>Groups</TD>            
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhiteoldGold>Account Status</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>Last Logon</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>Account Expiration</TD>                                          
          	  </TR>
     <%
  ...
  elseif Utility_ID = 21 and Admin_Access >= 4 then
    ...
    if rsUser.EOF then
      ...
      response.write "<BR>"
    %>
    	<TABLE WIDTH="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 BORDERCOLOR="#666666" BGCOLOR="#666666" ID="Table5">
        <TR>
          <TD>
  ...
  elseif Utility_ID = 24 and Admin_Access >= 4 then
    ...
    %>
      <FORM NAME="Dummy-5" ID="Form1">
    	<TABLE WIDTH="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 BORDERCOLOR="#666666" BGCOLOR="#666666" ID="Table7">
        <TR>
          <TD>
            <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0  WIDTH="100%" ID="Table8">
              <TR>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite>Region / Group / Sub-Region or Description</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite>Content Administrator&acute; Name</TD>
          		</TR>
     <%
      ...
      Do while not rsApproverGroups.EOF
        ...
        %>
        <SELECT LANGUAGE="JavaScript" ONCHANGE="window.location.href='site_utility.asp?Site_ID=<%=Site_ID%>&Utility_ID=<%=Utility_ID%>&Toggle=True&Group_ID=<%=rsApproverGroups("ID")%>&Approver_ID='+this.options[this.selectedIndex].value" NAME="Approver_ID" ID="Select1">
        <%                        
  ...
  elseif Utility_ID = 31 and Admin_Access >= 4 then
    ...
    %>
      <FORM NAME="Dummy-6" ID="Form2">
    	<TABLE WIDTH="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 BORDERCOLOR="#666666" BGCOLOR="#666666" ID="Table9">
        <TR>
          <TD>
            <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0  WIDTH="100%" ID="Table10">
              <TR>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite>Region</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite>Account Administrator&acute; Name</TD>
          		</TR>
     <%
      ...
      Do while not rsApproverGroups.EOF
        ...
        response.write "<TD BGCOLOR=""#FFFFFF"" ALIGN=""LEFT"" CLASS=Medium VALIGN=MIDDLE>"
        %>
        <SELECT LANGUAGE="JavaScript" ONCHANGE="window.location.href='site_utility.asp?Site_ID=<%=Site_ID%>&Utility_ID=<%=Utility_ID%>&Toggle=True&Group_ID=<%=rsApproverGroups("ID")%>&Approver_ID='+this.options[this.selectedIndex].value" NAME="Approver_ID" ID="Select2">
        <%                        
  ...
  elseif (Utility_ID = 20 or Utility_ID = 22 or Utility_ID = 23 or Utility_ID = 30 or Utility_ID = 39 or Utility_ID = 40 or Utility_ID = 41) and Admin_Access >= 4 then
    ...
    if rsUser.EOF then
      ...
      response.write "<BR>"
    %>
    	<TABLE WIDTH="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 BORDERCOLOR="#666666" BGCOLOR="#666666" ID="Table11">
        <TR>
          <TD>
  ...
  elseif (Utility_ID = 50 or Utility_ID = 51 or Utility_ID = 52 or Utility_ID=54 or Utility_ID = 60) and (Admin_Access = 2 or Admin_Access = 4 or Admin_Access >= 8) then
    ...
    if Group_ID <> "" or Country <> "" or Submitted_By > 0 or FLanguage <> "" then
      response.write "&nbsp;&nbsp;"
      %>      
      <A HREF="site_utility.asp?ID=site_utility&Site_ID=<%=Site_ID%>&Utility_ID=<%=Utility_ID%>&View=<%=View%>&Group_ID=&Country=&Category_ID=<%=Category_ID%>&LDate=<%=LDate%>" ONCLICK="window.location.href='site_utility.asp?ID=site_utility&Site_ID=<%=Site_ID%>&Utility_ID=<%=Utility_ID%>&Submitted_By=0&FLanguage=&View=<%=View%>&Group_ID=&Country=&Category_ID=<%=Category_ID%>&LDate=<%=LDate%>'"><SPAN CLASS=NavLeftHighlight1>&nbsp;Clear&nbsp;Filters&nbsp;</SPAN></A>      
      <%
    end if
    ...
    if Utility_ID = 54 then
      ...
      response.write "&nbsp;&nbsp;"
      %>
      <A HREF="javascript:void()" LANGUAGE="JavaScript" onClick="window.dateField = document.<%=FormName%>.LDate;calendar = window.open('/sw-common/sw-calendar_picker.asp','cal','WIDTH=200,HEIGHT=250');return false"><IMG SRC="/images/calendar/calendar_icon.gif" BORDER=0 HEIGHT="21"ALIGN=TOP></A>&nbsp;&nbsp;      
      <%      
    ...
    response.write "<TD CLASS=Small>" & vbCrLf
    %>
    <SELECT CLASS=Small LANGUAGE="JavaScript" ONCHANGE="window.location.href='/SW-Administrator/site_utility.asp?ID=site_utility&Site_ID=<%=Site_ID%>&Utility_ID=<%=Utility_ID%>&Campaign=<%=Campaign%>&Submitted_By=<%=Submitted_By%>&FLanguage=<%=FLanguage%>&LDate=<%=LDate%>&Category_ID=<%=Category_ID%>&View=<%=View%>&Group_ID=<%=Group_ID%>&Sort_By=<%=Sort_By%>&Country='+this.options[this.selectedIndex].value;document.getElementById('Standby').style.visibility = 'visible';" NAME="Country" ID="Select6">
    <%
    ...
    response.write "<TD CLASS=Small>" & vbCrLf
    %>
    <SELECT CLASS=Small LANGUAGE="JavaScript" ONCHANGE="window.location.href='/SW-Administrator/site_utility.asp?ID=site_utility&Site_ID=<%=Site_ID%>&Utility_ID=<%=Utility_ID%>&Campaign=<%=Campaign%>&LDate=<%=LDate%>&Category_ID=<%=Category_ID%>&View=<%=View%>&Country=<%=Country%>&Sort_By=<%=Sort_By%>&FLanguage=<%=FLanguage%>&Group_ID=<%=Group_ID%>&Submitted_By='+this.options[this.selectedIndex].value;document.getElementById('Standby').style.visibility = 'visible';" NAME="Submitted_By" ID="Select8">
    <%
    ...
    SQL =       "SELECT distinct dbo.Calendar.*, dbo.Calendar_Category.Title AS Category, dbo.Calendar_Category.Sort, dbo.Literature_Items_US.STATUS AS Lit_Status, dbo.Literature_Items_US.STATUS_Name AS Lit_Status_Name, " &_
                ...
                "       dbo.Literature_Items_US.CD AS Lit_CD, dbo.Literature_Items_US.DISPLAY AS Lit_Display, dbo.Literature_Items_US.VIDEO_NTSC AS Lit_Video_NTSC, dbo.Literature_Items_US.Active_Flag AS Lit_Active_Flag, " &_
                "       dbo.Literature_Items_US.PDF AS Lit_PDF, dbo.Literature_Items_US.FAX AS Lit_FAX,dbo.Literature_Items_US.WEB AS Lit_WEB, dbo.Literature_Items_US.VIDEO_PAL AS Lit_Video_PAL, UserData.FirstName AS FirstName, UserData.LastName AS LastName, CASE dbo.Calendar.Clone WHEN 0 THEN dbo.Calendar.ID ELSE dbo.Calendar.Clone END AS PC_Order," &_
    ...
    if FLanguage <> "" then
      SQL = SQL & "AND Calendar.Language='" & FLanguage & "' "
    end if
    ...
    if Campaign <> 0 then
      ...
      select case Sort_By
        case 1  ' Asset ID
          SQL = SQL & "ORDER BY Calendar.Status, Calendar.ID, Calendar.Revision_Code Desc, Lit_Active_Flag "
        ...
        case 4  ' Category, Sub Category, Begin Date, ID
          'SQL = SQL & "ORDER BY Calendar.Code, Calendar.Sub_Category, Calendar.BDate, Calendar.ID,dbo.Literature_Items_US.ACTIVE_FLAG, Calendar.Revision_Code Desc "        
           SQL = SQL & "ORDER BY Calendar_Category.Sort,Calendar_Category.Title,Calendar.Product,Calendar.Title, Calendar.BDate, Calendar.ID,dbo.Literature_Items_US.ACTIVE_FLAG, Calendar.Revision_Code Desc "        
        ...
        case 8  ' Category, Sub Category
          SQL = SQL & "ORDER BY Calendar_Category.sort, Calendar_Category.Title, Calendar.Sub_Category, Calendar.Product,Calendar.Title, Calendar.BDate, Calendar.ID, dbo.Literature_Items_US.ACTIVE_FLAG, Calendar.Revision_Code Desc "        
        case 9          
          SQL = SQL & "ORDER BY Calendar_Category.sort, Calendar_Category.Title, Calendar.Product, Calendar.Sub_Category, Calendar.Title, Calendar.BDate, Calendar.ID, dbo.Literature_Items_US.ACTIVE_FLAG, Calendar.Revision_Code Desc "        
        case else
...
'		 rsUserClone.Fields.append rsUser.fields(iUserfieldCount).name,200,500,64
 '     next
    ...
    do while not rsUser.EOF and Record_Number <= Record_Limit
      if rsUser("ID") <> Asset_ID_Old then
        ...
        if (CDate(rsUser("LDate")) < CDate(rsUser("BDate"))) then
          ...
          if CInt(rsUser("Status")) = 1 and (CDate(rsUser("LDate")) > Date()) and (CDate(rsUser("LDate")) < CDate(rsUser("BDate"))) then
        ...
        <TR>
          <TD-->
            ...
            <TABLE CELLPADDING=2 CELLSPACING=1 BORDER=0  WIDTH="100%" ID="Table13">
              <TR ID="ContentHeader1">
                <TD BGCOLOR="#666666" ALIGN="RIGHT" CLASS=SmallBoldWhite><%=Translate("Asset ID",Login_Language,conn)%></TD>              
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite><%=Translate("Category",Login_Language,conn)%></TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite><%=Translate("Sub Category",Login_Language,conn)%></TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite><%=Translate("Product or Product Series",Login_Language,conn)%></TD>                
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite><%=Translate("Title",Login_Language,conn)%></TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite><%=Translate("Item Number",Login_Language,conn)%></TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT" CLASS=SmallBoldWhite><%=Translate("LAN",Login_Language,conn)%></TD>
                ...
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>OLV</TD>            
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>OLD</TD>            
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>OLS</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>SSV</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>SSD</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>SSS</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>OLL</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>OLG</TD>              
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>EEF</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>EDL</TD>                
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>LOS</TD>                                
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite><%=Translate("Total",Login_Language,conn)%></TD>              
          		</TR>
        <%
  ...
  elseif Utility_ID = 98 and Admin_Access >= 4 then
    ...
    if Not rsStatus.EOF then
      %>
    	<TABLE WIDTH="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 BORDERCOLOR="#666666" BGCOLOR="#666666" ID="Table14">
        <TR>
          <TD>
            <TABLE CELLPADDING=4 CELLSPACING=1 BORDER=0  WIDTH="100%" ID="Table15">
              <TR>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>Begin Time</TD>              
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>End Time</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   CLASS=SmallBoldWhite>Elapsed<BR>> 1 sec</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>Uploaded<BR>By</TD>                
                <TD BGCOLOR="#666666" ALIGN="LEFT"   CLASS=SmallBoldWhite>Source</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   CLASS=SmallBoldWhite>Destination</TD>
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>File Size</TD>            
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>Status</TD>            
                <TD BGCOLOR="#666666" ALIGN="CENTER" CLASS=SmallBoldWhite>Error</TD>
                <TD BGCOLOR="#666666" ALIGN="LEFT"   CLASS=SmallBoldWhite>Error<BR>Description</TD>
          		</TR>
      <%
    end if
...
<SCRIPT language="JavaScript">
  <!--
    ...
    {
//        window.open("ExportToExcel.asp?Site_Id=" + <%=Site_Id%> + "&CategoryId=" + <%=Category_ID%>  + "&GroupId=" + <%=Group_ID%> + "&Language=" + '<%=FLanguage%>' + "&Country=" + '<%=Country%>' + "&Submitted_By=" + <%=submitted_by%> + "&Sort_By=" + <%=Sort_By%> + "&Campaign=" + <%=Campaign%>);
