...
<INPUT TYPE="Hidden" NAME="Connection_Speed" VALUE="1">             <!-- See Download_Time Table -->
<INPUT TYPE="Hidden" NAME="Subscription" VALUE="off">               <!-- 'on' = Enabled -->
<INPUT TYPE="Hidden" NAME="Subscription_Method" VALUE="">
<INPUT TYPE="Hidden" NAME="Account_Language" VALUE="elo">           <!-- See Language Table -->
<INPUT TYPE="Hidden" NAME="Fluke_ID" VALUE="123456">                <!-- Required for Order Inquiry -->
<INPUT TYPE="Hidden" NAME="Core_ID" VALUE="">
<INPUT TYPE="Hidden" NAME="eStore_ID" VALUE="">
<INPUT TYPE="Hidden" NAME="Comment" VALUE="">
<INPUT TYPE="Hidden" NAME="Logon" VALUE="">
<INPUT TYPE="Hidden" NAME="Aux_0" VALUE="no">                       <!-- Required Default Value -->
<INPUT TYPE="Hidden" NAME="Aux_1" VALUE="no">                       <!-- Required Default Value -->
...
<INPUT TYPE="Hidden" NAME="Business_System" VALUE="MFG">
...
<INPUT TYPE="Hidden" NAME="ExpirationDate" VALUE="12/31/<%=Year(Date())%>">
...
<INPUT TYPE="Hidden" NAME="Comment" VALUE="">
<INPUT TYPE="Hidden" NAME="Logon" VALUE="">
<INPUT TYPE="Hidden" NAME="Aux_0" VALUE="no">
<INPUT TYPE="Hidden" NAME="Aux_1" VALUE="no">
<INPUT TYPE="Hidden" NAME="Aux_2" VALUE="">
<INPUT TYPE="Hidden" NAME="Aux_3" VALUE="">
<INPUT TYPE="Hidden" NAME="Aux_4" VALUE="">
<INPUT TYPE="Hidden" NAME="Aux_5" VALUE="">
...
<INPUT TYPE="Hidden" NAME="Reg_Approval_Date" VALUE="<%=Year(Date())%>">  <!-- if initial update, this date must be supplied -->
<INPUT TYPE="Hidden" NAME="Reg_Admin" VALUE="5145">
<INPUT TYPE="Hidden" NAME="Reg_Site_Code" VALUE="Find-Sales">
