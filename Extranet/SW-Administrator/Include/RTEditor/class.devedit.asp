...
%>
<!--#include virtual="/include/RTEditor/Lang/Language.asp"-->
<!--#include virtual="/include/RTEditor/class.fileupload.asp" -->
<%
	...
	private sub DisplayIncludes (file, errorMsg)
		...
		if file = "enc_functions.js" then
			includeFile = Server.mapPath("/include/RTEditor/Includes/" & file)
		else
			includeFile = Server.mapPath("Includes/" & file)
		End if
		...
		if (fso.FileExists(includeFile)=true) Then
			...
			scriptName = Replace(scriptDir & scriptName,"/de/","/")
	...
	%>
	<link rel="stylesheet" href="/include/RTEditor/Includes/de_styles.css" type="text/css">
	<% else %>
	<link rel="stylesheet" href="/include/RTEditor/Includes/de_styles.css" type="text/css">
	<% end if
	...
	if ToDo = "InsertImage" Then
		...
		%><!-- #INCLUDE virtual="/include/RTEditor/Includes/insert_image.asp" --><%
 ...
 '       			includeFile = Server.mapPath("/include/RTEditor/Includes/jsfunctions.inc")
 ...
 '       			End if
					...
					%>
						<script language="JavaScript" src="/include/RTEditor/Includes/ro_attributes.js" type="text/javascript"></script>
						<script language="JavaScript" src="/include/RTEditor/Includes/ro_xml.js" type="text/javascript"></script>
						<script language="JavaScript" src="/include/RTEditor/Includes/ro_stringbuilder.js" type="text/javascript"></script>
					<%
					'end if
					%>
					<script>
							...
							var URL = "<%=URL%>"
							var ScriptName = "<%=Replace(Replace(Replace(scriptName,"/de/","/"),"/Include/RTEditor/",""),"/SW-Administrator/class.devedit.asp","/Include/RTEditor/class.devedit.asp")%>"
					...
					<script language="JavaScript" src="/include/RTEditor/Includes/de_functions.js" type="text/javascript"></script>
        			...
        			'Include the toolbar
        			%><!-- #INCLUDE virtual="/include/RTEditor/Includes/toolbar.asp" -->
        							...
        							<table cellpadding=0 cellspacing=0 width=100% style="background-color: threedface" class=status>
        								<tr>
        									<td background=/Include/RTEditor/Images/status_border.gif height=22><img style="cursor:hand;" id=editTab src=/include/RTEditor/Images/status_edit_up.gif width=98 height=22 border=0 onClick=editMe()><img style="cursor:hand; <% if e__disableSourceMode = true then %>display:none<% end if %>" id=sourceTab src=/include/RTEditor/Images/status_source.gif width=98 height=22 border=0 onClick=sourceMe()><img style="cursor:hand; <% if e__disablePreviewMode = true then %>display:none<% end if %>" id=previewTab src=/include/RTEditor/Images/status_preview.gif width=98 height=22 border=0 onClick=previewMe()></td>
        									<td background=/Include/RTEditor/Images/status_border.gif id=statusbar align=right valign=bottom><img src=/include/RTEditor/Images/button_zoom.gif width=42 height=17 valign=bottom onmouseover="button_over(this);" onmouseout="button_out(this);" onmousedown="button_down(this);" class=toolbutton onClick="showMenu('zoomMenu',65,178)"></td>
        								</tr>
        							</table>
        						</td>
        					</tr>
