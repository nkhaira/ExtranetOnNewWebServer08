...
Dim Procedure_Path
Procedure_Path = "/upload/portocal/procedures/"
Procedure_Path = "/met-support-gold/download/portocal/procedures/"
...
if not rsProcedures.EOF then
    ...
    response.write "<TR VALIGN=TOP>"
      ...
      if not isblank(rsProcedures.Fields("Options").Value) then
  	  ...
  	  strHREF = "<A HREF=""/sw-common/MSG_Download_File.asp?category=portocal&filename=" & Server.URLEncode(rsProcedures.Fields("FileName").value) & """>"          
...
'response.write("iCounter: " & iCounter & "<BR>")
  ...
  response.write "<LI><SPAN CLASS=NormalBoldRed>Sorry.</SPAN>&nbsp;&nbsp;" & Translate("There are no calibration procedures found that match your search critera.  Please adjust your criteria and try again.",Login_Language,conn) & "</LI><BR><BR>"
	...
	response.write "<A HREF=""MSG_Portocal_Procedure_Form.asp"
  if request("lv") <> "" then
...
strOption = Trim(Replace(Replace(UCase(Request("option")),"FLUKE-","FLUKE "), "*", "%"))
  ...
  strPreviousPage = "<a href=""MSG_Portocal_Procedure_Results.asp?CurrPage=" & iCurrPage - 1 & "&Make=" & strMake & "&Model=" & strModel & "&CalType=" & strCalType & "&MinSoftVer=" & strMinSoftVer & "&Option=" & strOption & strLevelOutput2 & """>"
  strPreviousPage = strPreviousPage & "<SPAN CLASS=NAVLEFTHIGHLIGHT1>&nbsp;&nbsp;&lt;&lt;&nbsp;&nbsp;</A></SPAN>&nbsp;&nbsp;"

  strNextPage = "<a href=""MSG_Portocal_Procedure_Results.asp?CurrPage=" & iCurrPage + 1 & "&Keyword=" & "&Make=" & strMake & "&Model=" & strModel & "&CalType=" & strCalType & "&MinSoftVer=" & strMinSoftVer & "&Option=" & strOption & strLevelOutput2 & """>"
  strNextPage = strNextPage & "<SPAN CLASS=NAVLEFTHIGHLIGHT1>&nbsp;&nbsp;&gt;&gt;&nbsp;&nbsp;</A></SPAN>&nbsp;&nbsp;"

  strNewSearch = "<A HREF=""MSG_Portocal_Procedure_Form.asp" & strLevelOutput1 & """><SPAN CLASS=NAVLEFTHIGHLIGHT1>&nbsp;&nbsp;New Search&nbsp;&nbsp;</SPAN></A>"
...
sub Write_Pages(iNumPages, iCurrPage, strKeyword, strCalibrator, strLevel)
  ...
  for iCounter = 1 to iNumPages
	if iCounter = 26 then
	  	...
	  	response.write "<A HREF=""MSG_Portocal_Procedure_Results.asp?currpage=" & iCounter & "&Make=" & strMake & "&Model=" & strModel & "&CalType=" & strCalType & "&MinSoftVer=" & strMinSoftVer & "&Option=" & strOption 
