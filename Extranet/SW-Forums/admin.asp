...
Bar_Title       = Translate(Site_Description,Login_Language,conn) & "<BR><FONT CLASS=SmallBoldGold>" & Translate("Forum",Login_Language,conn) & " / " & Translate("Discussion Group",Login_Language,conn) & " - " & Translate("Forum Administrator",Login_Language,conn) & "</FONT>"
...
response.write "<BR><FONT CLASS=SmallBold>" & Translate("Forum Administrator",Login_Language,conn) & "</FONT>"
response.write "</H3>"

Call FORUM_LINK_DISC
Call ADMIN_TOOLS_DISC
