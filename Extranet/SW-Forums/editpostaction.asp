...
Bar_Title       = Translate(Site_Description,Login_Language,conn) & "<BR><FONT CLASS=SmallBoldGold>" & Translate("Forum",Login_Language,conn) & " / " & Translate("Discussion Group",Login_Language,conn) & " - " & Translate("Message Status",Login_Language,conn) & "</FONT>"
...
response.write "<BR><FONT CLASS=SmallBold>" & Translate("Message Status",Login_Language,conn) & "</FONT>"
response.write "</H3>"
response.write "<BR>"

Call FORUM_LINK_DISC
Call SAVE_EDITED_MESSAGE_DISC
Call PARENT_MESSAGE_LINK_DISC
Call CLEANUP_DISC
