...
if Script_Debug = false then
 ...
 ' Dim GroupsShortDesc
  ...
  ' --------------------------------------------------------------------------------------
      ...
      ' Business System
      if not isblank(request("txtPriceListCode")) then 
        sqlf = sqlf & ",Pricelist_Code"       
        sql  = sql  & ",'" & replacequote(request("txtPriceListCode")) & "'"
        sqlu = sqlu & ",Pricelist_Code=" & "'" & replacequote(request("txtPriceListCode")) & "'"
      else  
        sqlf = sqlf & ",Pricelist_Code"       
        sql  = sql  & ",NULL"
        sqlu = sqlu & ",Pricelist_Code=NULL"
      end if
