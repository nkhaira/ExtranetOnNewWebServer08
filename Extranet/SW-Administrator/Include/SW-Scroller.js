...
* Date    : 11/01/2000                                                        *
*                                                                             *
* Creates scrolling displays on a page. Multiple scrollers can                *
...
function scrollerCreate() {
  ...
  // I need to modify this to handle CLASS for CSS -- But for now just do it the old way (kdw).
