...
if not rsAccount.EOF then
  ...
  msg.From = """" & Sender & """ <WebMail@Fluke.com>"
  msg.Sender = """" & Sender & """ <WebMail@Fluke.com>"
  msg.ReplyTo = rsAccount("Email")
else
  Send_Flag = False
end if
...
'msg.BodyPart.CharSet = "iso-8859-1"
msg.BodyPart.CharSet = rsLanguage("Name_CharSet")

if LCase(Login_Language) = "por" then
	'Mailer.Encoding = 1
else
	'Mailer.Encoding = 2
end if
