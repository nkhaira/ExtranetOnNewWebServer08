...
Bar_Title       = Translate(Site_Description,Login_Language,conn) & "<BR><FONT CLASS=SmallBoldGold>" & Translate("Forum",Login_Language,conn) & " / " & Translate("Discussion Group",Login_Language,conn) & " - " & Translate("Search Results",Login_Language,conn) & "</FONT>"
...
response.write "<BR><FONT CLASS=SmallBold>" & Translate("Search Results",Login_Language,conn) & "</FONT>"
response.write "</H3>"
