...
if not rsUser.EOF then		
  ...
  'http://fluke.informationstore.net/extranet/default.asp replace with http://fluke.is.syncforce.com/extranet/default.asp
  'For RI 1626 on 04th May 2011 by nkulkarn
  'http://fluke.is.syncforce.com/extranet/default.asp replace with https://fluke.is.syncforce.com/extranet/default.asp
  'For RI 1735 on 20th Jul 2011 by nkulkarn
 
  response.write "<FORM METHOD=""POST"" ACTION=""https://fluke.is.syncforce.com/extranet/default.asp"" ID=FORM1 NAME=FORM1>" & vbCrLf
