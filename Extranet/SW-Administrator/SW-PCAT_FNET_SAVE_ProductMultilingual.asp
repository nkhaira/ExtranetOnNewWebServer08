...
//            //sortList(strTo);
	...
	//var tempyear=ValidateStartEndYears();
		...
		alert('Please enter valid Asset URL. Sample URL format: http://us.fluke.com');
		return false;
		}
...
<option value="en-m2">en-m2</option>
<option value="en-m3">en-m3</option>
<option value="en-my">en-my</option>
<option value="en-ph">en-ph</option>
<option value="en-r0">en-r0</option>
...
<option value="en-vn">en-vn</option>
			  ...
			  <option value="fr-be">fr-be</option>
                    ...
                    <option value="fr-m1">fr-m1</option>
			  ...
			  <option value="pl-pl">pl-pl</option>		
                    ...
                    <option value="pt-m2">pt-m2</option>
	  ...
	  (mm/dd/yyyy)
        ...
        <tr>
            <td colspan='2' align='left'> Use this Asset URL for linking assets outside of the Partner Portal to any Product Category (Pcat) and Web Category selected.<br/> Links on product pages will appear in the Knowledge and Information Tab. You must specifiy the complete URL.<br/> i.e. http://assets.fluke.com/documents/training1.doc
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td colspan='2' align='left'> <b>Copy to:</b> <br />Note: Hold the shift key to select multiple language-locales.<br />
            </td>
        </tr>        
        <tr>
            <td>
...
<option value="vi-vn">vi-vn</option>
        ...
        <tr>
            ...
            <td CLASS=Medium ALIGN=left>
               <input type='button' id='btnClose' name='btnClose' CLASS='NavLeftHighlight1' onclick="closeLocalizeWindow('<%=Session("PopUpURL") %>')" value='Close' />
...
function closeLocalizeWindow(val) {
