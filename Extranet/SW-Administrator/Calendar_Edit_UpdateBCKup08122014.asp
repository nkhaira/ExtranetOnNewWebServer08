...
'                  end if  
        ...
        <tr>
            ...
            <td bgcolor="White" align="LEFT" class="Medium">
                <%
                        dim strCDNHiddVal
                        strCDNHiddVal = "False"
                        response.write "<INPUT TYPE=""Checkbox"" NAME=""CDN_Required"""
                        ...
                        response.write "<INPUT TYPE=""Hidden"" NAME=""hidCDN_Required"" VALUE=""" 
        ...
        <tr>
            ...
            <td bgcolor="White" align="LEFT" class="Medium">
               ...
               <% if( rs("CDN_Required") = -1 and Site_ID=46 ) then %>
