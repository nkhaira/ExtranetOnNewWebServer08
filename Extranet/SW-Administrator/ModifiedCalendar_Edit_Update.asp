...
'      rsCalendar.Open SQL, conn, 3, 3
    ...
    %>
    <FORM NAME="<%=FormName%>" ACTION="/SW-Administrator/Calendar_admin.asp?FileUpEE_Flag=<%=CInt(FileUpEE_Flag)%>&FileUpEE_Remote_Flag=<%=CInt(FileUpEE_Remote_Flag)%>" METHOD="Post" ENCTYPE="MULTIPART/FORM-DATA" onKeyUp="highlight(event)" onClick="highlight(event)" onsubmit="return CheckRequiredFields();">
