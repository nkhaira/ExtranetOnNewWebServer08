...
Screen_Title    = Translate(Site_Description,Alt_Language,conn) & " - " & Translate("Forum Archive",Alt_Language,conn)
Bar_Title       = Translate(Site_Description,Login_Language,conn) & "<BR><FONT CLASS=SmallBoldGold>" & Translate("Forum",Login_Language,conn) & " / " & Translate("Discussion Group",Login_Language,conn) & " - " & Translate("Archived Messages",Login_Language,conn) & "</FONT>"
...
response.write "<BR><FONT CLASS=SmallBold>" & Translate("Archived Messages",Login_Language,conn) & "</FONT>"
response.write "</H3>"
