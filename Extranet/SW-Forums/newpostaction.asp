...
Bar_Title       = Translate(Site_Description,Login_Language,conn) & "<BR><FONT CLASS=SmallBoldGold>" & Translate("Forum",Login_Language,conn) & "</FONT>"
...
response.write "<BR><FONT CLASS=SmallBold>" & Translate("Message Posting Status",Login_Language,conn) & "</FONT>"
response.write "</H3>"

Call FORUM_LINK_DISC
Call POST_MESSAGE_DISC
